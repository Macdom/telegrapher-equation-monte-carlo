...
set out "plots/0/mc0_3_075.png"
	set title 'a) f0 = 0 Hz, N = 10^3, tmax = 7.5 ns' font ", 20"
...
set out "plots/0/mc0_5_075.png"
	set title 'f0 = 0, N = 10^5, tmax = 7.5 ns'
	set ylabel 'u(x)'
	set xlabel 'x'
    plot 'out0.txt' u 1:2 w l lt 1 lw 2 t 'u_A',\
...
set out "plots/0/mc0_5_075_dif.png"
	set title 'c) f0 = 0 Hz, N = 10^5, tmax = 7.5 ns'
	set ylabel 'u_A - u_{num}'
	set xlabel 'x'
    plot 'out0.txt' u 1:8 w l lt 1 lw 2 t 'u_A - u_{num}'

set out "plots/0/mc0_3_10.png"
	set title 'd) f0 = 0 Hz, N = 10^3, tmax = 10 ns'
	set ylabel 'u(x)'
	set xlabel 'x'
...
set out "plots/0/mc0_5_10.png"
	set title 'f0 = 0, N = 10^5, tmax = 10 ns'
	set ylabel 'u(x)'
	set xlabel 'x'
...
set out "plots/0/mc0_5_15.png"
	set title 'f0 = 0, N = 10^5, tmax = 15 ns'
	set ylabel 'u(x)'
	set xlabel 'x'
    plot 'out0.txt' u 1:16 w l lt 1 lw 2 t 'u_A',\
...
set out "plots/0/mc0_4_20.png"
	set title 'f0 = 0, N = 10^4, tmax = 20 ns'
	set ylabel 'u(x)'
	set xlabel 'x'
    plot 'out0.txt' u 1:23 w l lt 1 lw 2 t 'u_A',\
...
set out "plots/0/mc0_4_20_dif.png"
	...
	set title 'f0 = 0, N = 10^5, tmax = 20 ns'
	set ylabel 'u(x)'
	set xlabel 'x'
    plot 'out0.txt' u 1:23 w l lt 1 lw 2 t 'u_A',\
...
set out "plots/0/mc0_3_25.png"
	set title 'j) f0 = 0 Hz, N = 10^3, tmax = 25 ns'
	set ylabel 'u(x)'
	set xlabel 'x'
...
set out "plots/0/mc0_5_25.png"
	set title 'f0 = 0, N = 10^5, tmax = 25 ns'
	set ylabel 'u(x)'
	set xlabel 'x'
    plot 'out0.txt' u 1:30 w l lt 1 lw 2 t 'u_A',\
...
set out "plots/0/mc0_3_35.png"
	set title 'm) f0 = 0 Hz, N = 10^3, tmax = 35 ns'
	set ylabel 'u(x)'
	set xlabel 'x'
...
set out "plots/0/mc0_5_35.png"
	set title 'f0 = 0, N = 10^5, tmax = 35 ns'
	set ylabel 'u(x)'
	set xlabel 'x'
    plot 'out0.txt' u 1:44 w l lt 1 lw 2 t 'u_A',\
...
set out "plots/0/mc0_5_35_dif.png"
	set title 'o) f0 = 0 Hz, N = 10^5, tmax = 35 ns'
	set ylabel 'u_A - u_{num}'
	set xlabel 'x'
