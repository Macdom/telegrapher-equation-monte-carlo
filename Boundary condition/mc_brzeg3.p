...
set out "plots/3/mc3_3_075.png"
	set title 'f0 = 3 * 10^9, N = 10^3, tmax = 7.5 * 10^{-9}'
	set ylabel 'u(x)'
	set xlabel 'x'
...
set out "plots/3/mc3_4_075.png"
	set title 'f0 = 3 * 10^9, N = 10^4, tmax = 7.5 * 10^{-9}'
	set ylabel 'u(x)'
	set xlabel 'x'
    plot 'out3.txt' u 1:2 w l lt 1 lw 2 t 'u_A',\
...
set out "plots/3/mc3_5_075.png"
	set title 'f0 = 3 * 10^9, N = 10^5, tmax = 7.5 * 10^{-9}'
	set ylabel 'u(x)'
	set xlabel 'x'
    plot 'out3.txt' u 1:2 w l lt 1 lw 2 t 'u_A',\
...
set out "plots/3/mc3_3_10.png"
	set title 'f0 = 3 * 10^9, N = 10^3, tmax = 10 * 10^{-9}'
	set ylabel 'u(x)'
	set xlabel 'x'
...
set out "plots/3/mc3_4_10.png"
	set title 'f0 = 3 * 10^9, N = 10^4, tmax = 10 * 10^{-9}'
	set ylabel 'u(x)'
	set xlabel 'x'
    plot 'out3.txt' u 1:9 w l lt 1 lw 2 t 'u_A',\
...
set out "plots/3/mc3_5_10.png"
	set title 'f0 = 3 * 10^9, N = 10^5, tmax = 10 * 10^{-9}'
	set ylabel 'u(x)'
	set xlabel 'x'
...
set out "plots/3/mc3_3_15.png"
	set title 'f0 = 3 * 10^9, N = 10^3, tmax = 15 * 10^{-9}'
	set ylabel 'u(x)'
	set xlabel 'x'
...
set out "plots/3/mc3_4_15.png"
	set title 'f0 = 3 * 10^9, N = 10^4, tmax = 15 * 10^{-9}'
	set ylabel 'u(x)'
	set xlabel 'x'
    plot 'out3.txt' u 1:16 w l lt 1 lw 2 t 'u_A',\
...
set out "plots/3/mc3_5_15.png"
	set title 'f0 = 3 * 10^9, N = 10^5, tmax = 15 * 10^{-9}'
	set ylabel 'u(x)'
	set xlabel 'x'
    plot 'out3.txt' u 1:16 w l lt 1 lw 2 t 'u_A',\
...
set out "plots/3/mc3_3_20.png"
	set title 'f0 = 3 * 10^9, N = 10^3, tmax = 20 * 10^{-9}'
	set ylabel 'u(x)'
	set xlabel 'x'
...
set out "plots/3/mc3_4_20.png"
	set title 'f0 = 3 * 10^9, N = 10^4, tmax = 20 * 10^{-9}'
	set ylabel 'u(x)'
	set xlabel 'x'
    plot 'out3.txt' u 1:23 w l lt 1 lw 2 t 'u_A',\
...
set out "plots/3/mc3_4_20_dif.png"
	...
	set title 'f0 = 3 * 10^9, N = 10^5, tmax = 20 * 10^{-9}'
	set ylabel 'u(x)'
	set xlabel 'x'
    plot 'out3.txt' u 1:23 w l lt 1 lw 2 t 'u_A',\
...
set out "plots/3/mc3_3_25.png"
	set title 'f0 = 3 * 10^9, N = 10^3, tmax = 25 * 10^{-9}'
	set ylabel 'u(x)'
	set xlabel 'x'
...
set out "plots/3/mc3_4_25.png"
	set title 'f0 = 3 * 10^9, N = 10^4, tmax = 25 * 10^{-9}'
	set ylabel 'u(x)'
	set xlabel 'x'
    plot 'out3.txt' u 1:30 w l lt 1 lw 2 t 'u_A',\
...
set out "plots/3/mc3_5_25.png"
	set title 'f0 = 3 * 10^9, N = 10^5, tmax = 25 * 10^{-9}'
	set ylabel 'u(x)'
	set xlabel 'x'
    plot 'out3.txt' u 1:30 w l lt 1 lw 2 t 'u_A',\
...
set out "plots/3/mc3_3_35.png"
	set title 'f0 = 3 * 10^9, N = 10^3, tmax = 35 * 10^{-9}'
	set ylabel 'u(x)'
	set xlabel 'x'
...
set out "plots/3/mc3_4_35.png"
	set title 'f0 = 3 * 10^9, N = 10^4, tmax = 35 * 10^{-9}'
	set ylabel 'u(x)'
	set xlabel 'x'
    plot 'out3.txt' u 1:44 w l lt 1 lw 2 t 'u_A',\
...
set out "plots/3/mc3_5_35.png"
	set title 'f0 = 3 * 10^9, N = 10^5, tmax = 35 * 10^{-9}'
	set ylabel 'u(x)'
	set xlabel 'x'
    plot 'out3.txt' u 1:44 w l lt 1 lw 2 t 'u_A',\
