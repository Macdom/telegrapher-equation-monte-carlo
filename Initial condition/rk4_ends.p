...
set out "plots/rk4/ends/mc_f_10.png"
...
set out "plots/rk4/ends/mc_f_20.png"
	set title 'Algorytm RK4'
	set ylabel 'f(x)'
	set xlabel 'x'
	set xrange[2.5:5]
...
set out "plots/rk4/ends/mc_f_40.png"
	set title 'Algorytm RK4'
	set ylabel 'f(x)'
	set xlabel 'x'
	set xrange[1.8:5]
...
set out "plots/rk4/ends/mc_b_10.png"
	set title 'Algorytm RK4'
	set ylabel 'b(x)'
	set xlabel 'x'
	set xrange[-5:-2.9]
...
set out "plots/rk4/ends/mc_b_20.png"
	set title 'Algorytm RK4'
	set ylabel 'b(x)'
	set xlabel 'x'
	set xrange[-5:-2.5]
...
set out "plots/rk4/ends/mc_b_40.png"
	set title 'Algorytm RK4'
	set ylabel 'b(x)'
	set xlabel 'x'
	set xrange[-5:-1.8]
